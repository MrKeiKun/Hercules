...
struct skill_interface {
	...
	int (*get_type) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_hit) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_inf) (int skill_id);
	int (*get_ele) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_nk) (int skill_id);
	int (*get_max) (int skill_id);
	int (*get_range) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_range2) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_splash) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_hp) (int skill_id, int skill_lv);
	int (*get_mhp) (int skill_id, int skill_lv);
	int (*get_msp) (int skill_id, int skill_lv);
	int (*get_sp) (struct block_list *bl, int skill_id, int skill_lv);
	...
	int (*get_zeny) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_num) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_cast) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_delay) (struct block_list *bl, int skill_id, int skill_lv);
	...
	int (*get_castdef) (struct block_list *bl, int skill_id, int skill_lv);
	...
	int (*get_maxcount) (struct block_list *bl, int skill_id, int skill_lv);
	int (*get_blewcount) (struct block_list *bl, int skill_id, int skill_lv);
	...
	int (*get_cooldown) (struct block_list *bl, int skill_id, int skill_lv);
